...
Studentpimpl::Studentpimpl(int id, std::string name)
    : pimpl(new Studentpimpl::Impl(id, name)) {}
Studentpimpl::Studentpimpl() {}

std::string Studentpimpl::getName() { return pimpl->name; }
int Studentpimpl::getID() { return pimpl->ID; }
void Studentpimpl::setName(std::string name) { pimpl->name = name; }
void Studentpimpl::setID(int ID) { pimpl->ID = ID; }
