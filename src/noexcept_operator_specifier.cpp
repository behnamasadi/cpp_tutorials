...
2)noexcept operator
It tests if a function noexcept specification evalute to true or false at
complie time. noexcept(some compile time expression) and this returns a boolan
...
/*//////////////////////////// noexcept specifier ///////////////////////////*/
void func1() noexcept // equals to noexcept(true),this func can not throw
                      // exception
{}

void func2() noexcept(
    false) // equals to not using noexcept, means this func can throw exception
{}
