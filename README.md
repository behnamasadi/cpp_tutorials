...
- [Object Initialization & Static Lifetime](docs/initialization.md)
  - [Constructor Member Initializer Lists — declaration-order rule, latent bugs](docs/initialization.md#1-constructor-member-initializer-lists) (worked example: [src/class/constructor_initialization_list.cpp](src/class/constructor_initialization_list.cpp))
  - [Aggregate / Brace Initialization](docs/initialization.md#2-aggregate-initialization-brace-initialization)
  - [Copy Initialization](docs/initialization.md#3-copy-initialization)
  - [Direct Initialization](docs/initialization.md#4-direct-initialization)
  - [Default Initialization](docs/initialization.md#5-default-initialization)
  - [Value Initialization](docs/initialization.md#6-value-initialization)
  - [Zero Initialization](docs/initialization.md#7-zero-initialization)
  - [Uniform / List Initialization (C++11)](docs/initialization.md#8-uniform--list-initialization-c11)
