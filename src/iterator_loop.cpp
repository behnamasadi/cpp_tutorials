...
void rangeBasedVsIteratorLoopVsForeach()
{
    ...
    Range-for is as fast as possible since it caches the end iterator, uses pre-increment and only
    dereferences the iterator once.
    */
...
/*
begin, end:
begin will return an iterator or a const_iterator depending on the const-qualification of
...
int main()
{
    rangeBasedVsIteratorLoopVsForeach();
}
