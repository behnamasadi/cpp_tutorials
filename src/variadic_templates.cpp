...
//////////////////////////////////Second Example////////////////////////////////
/*
the expression square(rest).... Recall that the ... operator will expand an entire expression, so for example, when it’s called with square(4.0, 6.0)..., the compiler expands this as square(4.0), square(6.0)
