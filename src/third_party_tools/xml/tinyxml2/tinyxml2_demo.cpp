...
void generatingXMLDocumentS() 
{
	...
	int value, index;
	docFromFile.FirstChildElement()->FirstChildElement()->QueryIntAttribute("value", &value);
	std::cout <<"value: " <<value << std::endl;
	docFromFile.FirstChildElement()->FirstChildElement("textApproach")->FirstChildElement("index")->QueryIntText(&index);
	...
	*/
	...
	tinyxml2::XMLElement* textApproach = docFromFile.FirstChildElement()->FirstChildElement("textApproach");
