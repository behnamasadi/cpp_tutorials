...
void writingToReadOnlyMemory() {
  /*
  This occurs when the program writes to part of its own code segment or the
  read-only portion of the data segment. In the following the string "hello
  world" and constant variables is placed in the read-only section of the data
  segment.
  */
  char *s = "hello world";
  *s = 'H';
...
I get a segfault after around 261978 stack frames. The stack size limit on my
system is 8192 kilobytes. So, each stack frame in this case must be around 32
bytes. int main(int argc, char **argv)
{
