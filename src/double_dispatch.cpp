/*
In most object-oriented systems, the concrete function that is called from a function call in the code
 depends on the dynamic type of a single object and therefore they are known as single dispatch calls,
 or simply virtual function calls.
*/
#include <iostream>
...
{
    {
        ...
        std::cout<<"The output is correct, function overloading, without using any dynamic dispatch"<<std::endl;
...

    {
        ...
        std::cout<<"The output is wrong, while virtual functions are dispatched dynamically in C++, function overloading is done statically."<<std::endl;
    ...
    {
/*
1) In apolloSpaceShip_ptr, C++ looks up the correct method in the vtable. In this case, it will call
ApolloSpaceShip::collidingWith(Asteroid*).

2) ApolloSpaceShip::collidingWith(Asteroid*),  astroid_ptr->collidingWith(*this); will result in another vtable lookup.
*/
